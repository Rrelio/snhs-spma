                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapse6" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body p-2 pe-0 d-flex">
                                <ul class="list-group w-100" id="grade6-Sections">
                        ...
                        <div id="flush-collapse7" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body p-2 pe-0 d-flex">
                                <ul class="list-group w-100" id="grade7-Sections">
                        ...
                        <div id="flush-collapse8" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body p-2 pe-0 d-flex">
                                <ul class="list-group w-100" id="grade8-Sections">
                        ...
                        <div id="flush-collapse9" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body p-2 pe-0 d-flex">
                                <ul class="list-group w-100" id="grade9-Sections">
                        ...
                        <div id="flush-collapse10" class="accordion-collapse collapse"
                            aria-labelledby="flush-heading10" data-bs-parent="#accordionFlushExamples">
                            <div class="accordion-body p-2 pe-0 d-flex">
                                <ul class="list-group w-100" id="grade10-Sections">
                        ...
                        <div id="flush-collapse11" class="accordion-collapse collapse"
                            aria-labelledby="flush-heading11" data-bs-parent="#accordionFlushExamples">
                            <div class="accordion-body p-2 pe-0 d-flex">
                                <ul class="list-group w-100" id="grade11-Sections">
                        ...
                        <div id="flush-collapse12" class="accordion-collapse collapse"
                            aria-labelledby="flush-heading12" data-bs-parent="#accordionFlushExamples">
                            <div class="accordion-body p-2 pe-0 d-flex">
                                <ul class="list-group w-100" id="grade12-Sections">
            ...
            <div class="w-50 border-start ps-2 d-flex flex-column">
                ...
                <div class="container border rounded-3 py-2 flex-fill d-flex flex-column justify-content-center">
                    <form class="">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control rounded-2" id="sectionName" placeholder="Section">
                            <label for="sectionName">Section Name</label>
                        </div>
                        <div class="alert alert-danger p-0 px-2" role="alert" style="visibility: hidden;" id="sectionError">
                            <i class="bi bi-exclamation-triangle-fill"></i> &nbsp;<small>Don't leave any field blank</small>
                        </div>
                        <button type="button" class="spma-button-2 text-white rounded-pill w-fit px-3 mx-auto d-block my-2" onclick="setNewSection()">Submit <i class="bi bi-check2"></i></button>
                    </form>
                </div>
            </div>
        </div>
