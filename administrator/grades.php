<div class="d-flex flex-column h-100">
    <div class="bg-white container border p-3 h-100 d-flex flex-column" style="border-radius: 25px;">
        ...
        <div class="mt-4 overflow-auto flex-grow-1 d-flex">
            <div class="w-50 pe-1 overflowY-scroll">
                ...
                <div class="accordion accordion-flush" id="accordionFlushExamples">
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapse6" class="accordion-collapse collapse"
                            aria-labelledby="flush-heading6" data-bs-parent="#accordionFlushExamples">
                            <div class="accordion-body p-2 pe-0 d-flex">
                                <ul class="list-group w-100" id="grade6-Subjects">
                        ...
                        <div id="flush-collapse7" class="accordion-collapse collapse"
                            aria-labelledby="flush-heading7" data-bs-parent="#accordionFlushExamples">
                            <div class="accordion-body p-2 pe-0 d-flex">
                                <ul class="list-group w-100" id="grade7-Subjects">

                                </ul>
                            </div>
                        </div>
                        <h2 class="accordion-header" id="flush-heading8"><button class="accordion-button collapsed"
                        ...
                        <div id="flush-collapse8" class="accordion-collapse collapse"
                            aria-labelledby="flush-heading8" data-bs-parent="#accordionFlushExamples">
                            <div class="accordion-body p-2 pe-0 d-flex">
                                <ul class="list-group w-100" id="grade8-Subjects">

                                </ul>
                            </div>
                        </div>
                        <h2 class="accordion-header" id="flush-heading9"><button class="accordion-button collapsed"
                        ...
                        <div id="flush-collapse9" class="accordion-collapse collapse"
                            aria-labelledby="flush-heading9" data-bs-parent="#accordionFlushExamples">
                            <div class="accordion-body p-2 pe-0 d-flex">
                                <ul class="list-group w-100" id="grade9-Subjects">

                                </ul>
                            </div>
                        </div>
                        <h2 class="accordion-header" id="flush-heading10"><button class="accordion-button collapsed"
                        ...
                        <div id="flush-collapse10" class="accordion-collapse collapse"
                            aria-labelledby="flush-heading9" data-bs-parent="#accordionFlushExamples">
                            <div class="accordion-body p-2 pe-0 d-flex">
                                <ul class="list-group w-100" id="grade10-Subjects">

                                </ul>
                            </div>
                        </div>
                        <h2 class="accordion-header" id="flush-heading11"><button class="accordion-button collapsed"
                        ...
                        <div id="flush-collapse11" class="accordion-collapse collapse"
                            aria-labelledby="flush-heading9" data-bs-parent="#accordionFlushExamples">
                            <div class="accordion-body p-2 pe-0 d-flex">
                                <ul class="list-group w-100" id="grade11-Subjects">

                                </ul>
                            </div>
                        </div>
                        <h2 class="accordion-header" id="flush-heading12"><button class="accordion-button collapsed"
                        ...
                        <div id="flush-collapse12" class="accordion-collapse collapse"
                            aria-labelledby="flush-heading9" data-bs-parent="#accordionFlushExamples">
                            <div class="accordion-body p-2 pe-0 d-flex">
                                <ul class="list-group w-100" id="grade12-Subjects">
                ...
                <div class="container border rounded-3 py-2 flex-fill d-flex flex-column justify-content-center">
                    <form class="">
                        <div class="form-floating mb-3">
                            <select class="form-select" id="subjectGrade" aria-label="Floating label select example">
                            ...
                            <label for="subjectGrade">Grade level</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control rounded-2" placeholder="Subject" id="subjectName">
                            <label for="subjectName">Subject Name</label>
                        </div>
                        <div class="alert alert-danger p-0 px-2" role="alert" style="visibility: hidden;" id="subjectError">
                            <i class="bi bi-exclamation-triangle-fill"></i> &nbsp;<small id="subjectErrorMsg">Don't leave any field blank</small>
                        </div>
                        <button type="button" class="spma-button-2 text-white rounded-pill w-fit px-3 mx-auto d-block my-2" onclick="setNewSubject()">Submit <i class="bi bi-check2"></i></button>
                    </form>
                </div>
            </div>
        </div>
