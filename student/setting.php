            ...
            <div class="">
                ...
                <div class="py-2 text-center  ms-1 m-0 d-flex" style="overflow-x:auto;">
                    ...
                    <div class="color-pick d-inline rounded-4 p-1 border pointer text-center text-transparent px-2"
                        ...
                        onclick="changeAccentColor(this)" value="255, 154, 162"><i class="bi bi-check-circle"></i></div>
                    <div class="color-pick d-inline rounded-4 p-1 border pointer text-center text-transparent px-2"
                        style="background-color:rgb(253, 152, 67);" id="absolute-apricot"
                        onclick="changeAccentColor(this)" value="128, 168, 63"><i class="bi bi-check-circle"></i></div>
                    <div class="color-pick d-inline rounded-4 p-1 border pointer text-center text-transparent px-2"
                    ...
                    <div class="color-pick d-inline rounded-4 p-1 border pointer text-center text-transparent px-2"
                        ...
                        onclick="changeAccentColor(this)" value="126, 203, 180"><i class="bi bi-check-circle"></i></div>
                    <div class="color-pick d-inline rounded-4 p-1 border pointer text-center text-transparent px-2"
                    ...
                    <div class="color-pick d-inline rounded-4 p-1 border pointer text-center text-transparent px-2"
                        ...
                        onclick="changeAccentColor(this)" value="222,184,135"><i class="bi bi-check-circle"></i></div>
                    <div class="color-pick d-inline rounded-4 p-1 border pointer text-center text-transparent px-2"
