                    ...
                    <div class="col py-1 d-flex flex-column">
                        <div class="dashboard-top d-flex justify-content-between">
                            <div class="">
                                ...
                                <small class="text-black-50 text-truncate">Welcome & let's see how many activities your
                                    child left today.</small>
                            </div>
            ...
            <div class="container d-flex flex-column ps-xs-2 ps-sm-2 ps-md-3 ps-3 p-0 h-100 text-darkish overflow-auto">
                ...
                <div class=" text-center flex-fill mx-2"
                    ...
                    <img src="" alt="" class="img-fluid mx-auto d-block mt-3 border rounded-circle" style="width: 35%;"
                        id="userProfilePic">
                    <p class="fw-bold mt-2 mb-0 fs-5 text-darkerish" id="parentName">Parent Name</p>
                    <p id="parentChildName">Child Name</p>
                </div>
                <div>
                ...
                <div style="border-top: 1px rgba(0,0,0,.25) solid;">
                    <ul class="text-darkerish">
                        <li>
                            Child's Name:
                            <div class="text-center bg-white-50 rounded-pill me-2 fw-bold" id="infoChild">
